                                ...
                                <span class="dropdown" style="position: absolute;right: 3%;">
                                                ...
                                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                    <li role="presentation">
                                                        <a class="delete-article" href="" onclick="editArticle(<?php the_ID();?>,this)">
                                                    ...
                                                    <li role="presentation">
                                                        <a class= "modify-article" href=<?php echo $road . "/page-editor.php?id=" . get_the_ID(); ?>>
...
<script>
    function editArticle(the_id){
        if(event.currentTarget.className=="delete-article"){
            $.ajax({
                type: "GET",
        ...
        else if(event.currentTarget.className=="modify-article"){
            nextURL="<?php echo $road . "/page-editor.php?id="?>"+the_id;
