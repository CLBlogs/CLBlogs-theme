    ...
    <div id="wrapper" class="flow">
        ...
        <nav class="navbar navbar-default" id="search_nav">
            <div class="container-fluid">
                <form class="navbar-form" id="input_form"><input class="form-control" type="text" id="top-input"><button class="btn btn-default" id="search-botton" type="button"><i class="glyphicon glyphicon-search"></i></button></form>
            </div>
        </nav>
                ...
                <div id="main-flow" class="main-flow">
                    <div id="post-list" class="post-list">
                        <div class="blog_card"><a href="#">博客标题</a>
                            <div class="blog_div"><a href="#"></a><a class="abstract" href="#">前面我们研究了RPC的原理，市面上有很多基于RPC思想实现的框架，比如有Dubbo。今天就从Dubbo的SPI机制、服务注册与发现源码及网络通信过程去深入剖析下Dubbo。 Dubbo架构 概述 Dubbo是阿里巴巴公司开源的一个高性能优秀的服务框架，使得应用可通过高性能的RPC 实现服务<br></a></div>
                            <footer id="post-item-foot-4" class="post-item-foot">
                                ...
                                <a class="post-meta-iten" href="#"><i class="glyphicon glyphicon-star"></i><span>收藏</span></a><a class="post-meta-iten" href="#"><i class="glyphicon glyphicon-eye-open"></i><span><?php
                                    echo ' views: ';
